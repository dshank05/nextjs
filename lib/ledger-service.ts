...
export interface LedgerEntryData {
  ...
  transaction_type: 'PURCHASE' | 'DEBIT_NOTE' | 'DEBIT_NOTE_REVERSAL' | 'PAYMENT' | 'REFUND_RECEIVED' | 'PAYMENT_REVERSAL' | 'REFUND_REVERSAL' | 'PURCHASE_ADJUSTMENT' | 'PAYMENT_ADJUSTMENT'
