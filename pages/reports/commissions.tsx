      ...
      <div className="card">
        <div className="flex items-center justify-between mb-6">
          ...
          <ExportMenu
            ...
            columns={[
              ...
              { key: 'commission_amount', label: 'Commission', enabled: true },
              { key: 'total_amount', label: 'Total Amount', enabled: true }
            ]}
            config={{
              title: 'Commissions Report',
              fileName: `Commissions_Report_${getLocalDateString()}`
            }}
          />
        </div>
        ...
        {summary && (
          <div className="grid grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-slate-800 p-4 rounded-lg">
              <div className="text-sm text-slate-400 mb-1">Average Commission</div>
              <div className="text-2xl font-bold text-white">₹{summary.avg_commission.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</div>
            </div>
          </div>
        )}
        ...
        <div className="overflow-x-auto relative">
            ...
            <tbody>
              {data.map((record, idx) => (
                <tr key={idx}>
                  ...
                  <td className="text-right font-semibold text-green-400">₹{record.commission_amount.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</td>
          ...
          {data.length === 0 && !loading && (
            <div className="text-center py-8 text-slate-400">
              No commission records found with the current filters.
            </div>
          )}
        </div>
