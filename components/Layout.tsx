  ...
  const navigation: NavigationItem[] = [
    {
      ...
      subpages: [
        ...
        { name: 'PRODUCT CREATION', href: '#' },
        { name: 'PRODUCT VIEW PAGE', href: '#' },
      ],
    },
    {
      name: 'PURCHASE',
      ...
      subpages: [
        ...
        { name: 'PURCHASE CREATION', href: '#' },
        { name: 'PURCHASE VIEW PAGE', href: '#' },
      ],
    },
    {
      name: 'INVOICE',
      icon: '📄',
      subpages: [
        { name: 'INVOICE PAGE', href: '/invoices' },
        { name: 'INVOICE CREATION PAGE', href: '#' },
        { name: 'INVOICE VIEW PAGE', href: '#' },
      ],
    },
    {
      name: 'INVOICE C',
      icon: '📄',
      subpages: [
        { name: 'INVOICE C PAGE', href: '#' },
        { name: 'INVOICE C CREATION PAGE', href: '#' },
        { name: 'INVOICE C VIEW PAGE', href: '#' },
      ],
    },
    {
      name: 'ENTRY',
    ...
    },
    {
      ...
      subpages: [
        ...
        { name: 'PURCHASE RETURN', href: '/entry/purchasereturn' },
        { name: 'DEAD STOCK', href: '/entry/deadstock' },
        { name: 'OPENING / CLOSING STOCK', href: '#' },
        { name: 'MECHANIC SALE', href: '#' },
        { name: 'COMMISSIONS', href: '#' },
        { name: 'TRANSPORT COST', href: '#' },
        { name: 'PACKING / FORWARDING', href: '#' },
        { name: 'STAFF SALE', href: '#' },
        { name: 'BILL REFERNCE SALE', href: '#' },
        { name: 'BILL REFERNCE PURCHASE', href: '#' },
        { name: 'NOTES MENTIONED', href: '#' },
      ],
    },
  ];
